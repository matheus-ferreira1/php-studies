...
array_push($fruits, 'mango', 'raspberry'); // Adds to the end of the array
...
unset($fruits[2]); // IMPORTANT: removes the index as well
...
var_dump($arr3);
$arr4 = [...$arr1, ...$arr2]; // Use Spread Operator: merge the 2 arrays just like above
var_dump($arr4);

// Combine arrays (The first array become the Keys and the second one becomes values)
$a = ['green', 'red', 'yellow'];
$b = ['avocado', 'apple', 'banana'];
$c = array_combine($a, $b);

// Array of keys (create an array (0 indexed) of the keys)
$keys = array_keys($c);
