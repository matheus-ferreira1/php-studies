<?php // Php tag. If there is no html or other content below the php, there's need to close the php tag.
...
// If there is more content after the PHP, such as this file, it's necessary to have the ending tag.
?>
...
<body>
  ...
  <h1>Hello <?php echo 'Teus'; ?></h1>
  <!-- There no need to include the semi-colon if there's nothing after the statement -->
  <h1>Hello <?= 'Teuzo' ?></h1>
</body>
</html>
